...
__attribute__((always_inline)) WEAK void __csi_before_arithmetic_v4float(
    const csi_id_t arith_id, const csi_opcode_t opcode,
    const csi_ir_variable_category_t operand0_cat, const csi_id_t operand0_id,
...
__attribute__((always_inline)) WEAK void __csi_before_arithmetic_v8float(
    const csi_id_t arith_id, const csi_opcode_t opcode,
    const csi_ir_variable_category_t operand0_cat, const csi_id_t operand0_id,
...
__attribute__((always_inline)) WEAK void __csi_before_arithmetic_v16float(
    const csi_id_t arith_id, const csi_opcode_t opcode,
    const csi_ir_variable_category_t operand0_cat, const csi_id_t operand0_id,
...
__attribute__((always_inline)) WEAK void __csi_before_arithmetic_v2double(
    const csi_id_t arith_id, const csi_opcode_t opcode,
    const csi_ir_variable_category_t operand0_cat, const csi_id_t operand0_id,
...
__attribute__((always_inline)) WEAK void __csi_before_arithmetic_v4double(
    const csi_id_t arith_id, const csi_opcode_t opcode,
    const csi_ir_variable_category_t operand0_cat, const csi_id_t operand0_id,
...
__attribute__((always_inline)) WEAK void __csi_before_arithmetic_v8double(
    const csi_id_t arith_id, const csi_opcode_t opcode,
    const csi_ir_variable_category_t operand0_cat, const csi_id_t operand0_id,
