...
declare hidden void @_ZN4gbbs2lt10primitives5alterEjjRN4pbbs8sequenceIjEE(%"class.std::tuple.44.283.512.741"* noalias nocapture sret(%"class.std::tuple.44.283.512.741"), i32, i32, %"struct.pbbs::sequence.39.278.507.736"* nocapture readonly dereferenceable(16)) #7
...
; Function Attrs: ssp uwtable
declare hidden void @_ZN4gbbs7gbbs_io31read_compressed_symmetric_graphIN4pbbs5emptyEEENS_15symmetric_graphINS_20csv_bytepd_amortizedET_EEPKcbb(%"struct.gbbs::symmetric_graph.55.294.523.752"* noalias sret(%"struct.gbbs::symmetric_graph.55.294.523.752"), i8*, i1 zeroext, i1 zeroext) local_unnamed_addr #8
...
declare dso_local void @_ZN4gbbs7gbbs_io31read_unweighted_symmetric_graphEPKcbPcm(%"struct.gbbs::symmetric_graph.5.58.297.526.755"* sret(%"struct.gbbs::symmetric_graph.5.58.297.526.755"), i8*, i1 zeroext, i8*, i64) local_unnamed_addr #0
...
declare dso_local void @_ZN4gbbs7gbbs_io22parse_compressed_graphEPKcbb(%"class.std::tuple.11.63.302.531.760"* sret(%"class.std::tuple.11.63.302.531.760"), i8*, i1 zeroext, i1 zeroext) local_unnamed_addr #0
...
; Function Attrs: ssp uwtable
declare hidden void @_ZN4pbbs14random_shuffleINS_8sequenceIPN4gbbs13em_data_blockEEEEENS1_INT_10value_typeEEERKS6_NS_6randomE(%"struct.pbbs::sequence.28.65.304.533.762"* noalias sret(%"struct.pbbs::sequence.28.65.304.533.762"), %"struct.pbbs::sequence.28.65.304.533.762"* dereferenceable(16), i64) local_unnamed_addr #8
...
declare dso_local void @_ZN4gbbs16annotate_updatesERN4pbbs8sequenceISt5tupleIJjjEEEEdmb(%"struct.pbbs::sequence.62.94.333.562.791"* sret(%"struct.pbbs::sequence.62.94.333.562.791"), %"struct.pbbs::sequence.61.95.334.563.792"* dereferenceable(16), double, i64, i1 zeroext) local_unnamed_addr #0
...
declare dso_local void @_ZN4gbbs9connectit28liu_tarjan_options_to_stringB5cxx11ENS_14SamplingOptionENS_22LiuTarjanConnectOptionENS_21LiuTarjanUpdateOptionENS_23LiuTarjanShortcutOptionENS_20LiuTarjanAlterOptionE(%"class.std::__cxx11::basic_string.7.246.475.704"* sret(%"class.std::__cxx11::basic_string.7.246.475.704"), i32, i32, i32, i32, i32) local_unnamed_addr #0
...
; Function Attrs: ssp uwtable
declare dso_local void @_ZN9__gnu_cxx12__to_xstringINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEEcEET_PFiPT0_mPKS8_P13__va_list_tagEmSB_z(%"class.std::__cxx11::basic_string.7.246.475.704"* noalias sret(%"class.std::__cxx11::basic_string.7.246.475.704"), i32 (i8*, i64, i8*, %struct.__va_list_tag.186.425.654.883*)*, i64, i8*, ...) local_unnamed_addr #8
