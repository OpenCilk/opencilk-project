...
; CHECK-NEXT: define i32* @external_ret2_nrw(i32* nofree %n0, i32* nofree align 4 %r0, i32* nofree returned %w0)
...
; CHECK: Function Attrs: argmemonly nofree nosync nounwind
; CHECK-NEXT: define internal align 4 i32* @internal_ret1_rrw(i32* nofree nonnull align 4 dereferenceable(4) %r0, i32* nofree returned align 4 %r1, i32* nofree %w0)
...
; CHECK: Function Attrs: argmemonly nofree nosync nounwind
; CHECK-NEXT: define i32* @external_source_ret2_nrw(i32* nofree %n0, i32* nofree align 4 %r0, i32* nofree returned %w0)
