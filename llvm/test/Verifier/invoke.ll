...
entry:
; CHECK: Cannot invoke an intrinsic other than donothing, patchpoint, statepoint, coro_resume, coro_destroy, detached_rethrow, taskframe_resume, sync_unwind or clang.arc.attachedcall
