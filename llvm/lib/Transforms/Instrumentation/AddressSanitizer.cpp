...
struct AddressSanitizer {
  AddressSanitizer(Module &M, const GlobalsMetadata *GlobalsMD, TaskInfo &TI,
...
public:
  ...
  bool runOnFunction(Function &F) override {
    ...
    AddressSanitizer ASan(*F.getParent(), &GlobalsMD, TI, CompileKernel,
