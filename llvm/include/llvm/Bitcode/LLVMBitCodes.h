...
enum AttributeKindCodes {
  ...
  ATTR_KIND_STRAND_PURE = 94,
  ATTR_KIND_STRAND_NO_ALIAS = 95,
  ATTR_KIND_INJECTIVE = 96,
  ATTR_KIND_HYPER_VIEW = 97,
  ATTR_KIND_HYPER_TOKEN = 98,
  ATTR_KIND_REDUCER_REGISTER = 99,
  ATTR_KIND_REDUCER_UNREGISTER = 100,
};
