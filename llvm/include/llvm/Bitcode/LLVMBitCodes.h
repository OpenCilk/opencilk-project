...
enum FunctionCodes {
  ...
  FUNC_CODE_INST_DETACH = 59,    // DETACH: [bb#,bb#] or [bb#,bb#,bb#]
  FUNC_CODE_INST_REATTACH = 60,  // REATTACH [bb#]
  FUNC_CODE_INST_SYNC = 61,      // SYNC: [bb#]
};
...
enum AttributeKindCodes {
  ...
  ATTR_KIND_STRAND_PURE = 76,
  ATTR_KIND_STRAND_NO_ALIAS = 77,
  ATTR_KIND_INJECTIVE = 78,
  ATTR_KIND_REDUCER_REGISTER = 79,
  ATTR_KIND_REDUCER_VIEW = 80,
  ATTR_KIND_REDUCER_TOKEN = 81,
  ATTR_KIND_REDUCER_UNREGISTER = 82
};
