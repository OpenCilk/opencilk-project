...
void rule_of_four() {
  ...
  // CHECK: [[DETACHED]]:
  // CHECK: invoke void @_Z7makeBarv(%class.Bar* {{(nonnull )?}}sret(%class.Bar) {{.*}}%[[b5:.+]])
  ...
  // CHECK: [[DETACHED2]]:
  // CHECK: invoke void @_Z7makeBarv(%class.Bar* {{(nonnull )?}}sret(%class.Bar) {{.*}}%[[b4:.+]])
  ...
  // CHECK: [[DETACHED3]]:
  // CHECK: invoke void @_Z7makeBarv(%class.Bar* {{(nonnull )?}}sret(%class.Bar) {{.*}}%[[AGGTMP]])
  // CHECK-NEXT: to label %[[INVOKECONT:.+]] unwind label %[[DETLPAD3:.+]]
  // CHECK: [[INVOKECONT]]:
  // CHECK-NEXT: %[[CALL:.+]] = invoke {{.*}}dereferenceable(16) %class.Bar* @_ZN3BaraSES_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b0:.+]], %class.Bar* {{(nonnull )?}}%[[AGGTMP]])
  // CHECK-NEXT: to label %[[INVOKECONT2:.+]] unwind label %[[DETLPAD3_2:.+]]
  // CHECK: [[INVOKECONT2]]:
  // CHECK-NEXT: call void @_ZN3BarD1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP]])
  ...
  // CHECK: invoke void @_ZN3BarC1ERKS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP2]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[b0:.+]])
  ...
  // CHECK: [[INVOKECONT4]]:
  // CHECK-NEXT: call void @_ZN3BarD1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP2]])
...
void derived_class() {
  ...
  // CHECK: invoke void @_Z8makeDBarv(%class.DBar* {{(nonnull )?}}sret(%class.DBar) {{.*}}%[[REFTMP]])
  ...
  // CHECK-NEXT: invoke void @_ZN3BarC1EOS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b8:.+]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[CAST]])
  // CHECK-NEXT: to label %[[INVOKECONT2:.+]] unwind label %[[DETLPAD_2:.+]]
  // CHECK: [[INVOKECONT2]]:
  // CHECK-NEXT: call void @_ZN4DBarD1Ev(%class.DBar* {{(nonnull )?}}dereferenceable(16) %[[REFTMP]])
  ...
  // CHECK: %[[AGGTMP:.+]] = alloca %class.Bar
  // CHECK: invoke void @_ZN3BarC1ERKS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[b0:.+]])
  ...
  // CHECK: invoke void @_Z15makeDBarFromBar3Bar(%class.DBar* {{(nonnull )?}}sret(%class.DBar) {{.*}}%[[REFTMP2]], %class.Bar* {{(nonnull )?}}%[[AGGTMP]])
  ...
  // CHECK-NEXT: invoke void @_ZN3BarC1EOS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b2:.+]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[CAST2]])
  // CHECK-NEXT: to label %[[INVOKECONT5:.+]] unwind label %[[DETLPAD2_2:.+]]
  // CHECK: [[INVOKECONT5]]:
  // CHECK-NEXT: call void @_ZN4DBarD1Ev(%class.DBar* {{(nonnull )?}}dereferenceable(16) %[[REFTMP2]])
  ...
  // CHECK: %[[AGGTMP2:.+]] = alloca %class.Bar
  // CHECK: invoke void @_ZN3BarC1ERKS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP2]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[b7:.+]])
  ...
  // CHECK: invoke void @_Z15makeDBarFromBar3Bar(%class.DBar* {{(nonnull )?}}sret(%class.DBar) {{.*}}%[[REFTMP3]], %class.Bar* {{(nonnull )?}}%[[AGGTMP2]])
  ...
  // CHECK-NEXT: invoke {{.*}}void @_ZN3BarC1EOS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP3]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[CAST3]])
  // CHECK-NEXT: to label %[[INVOKECONT8:.+]] unwind label %[[DETLPAD3_2:.+]]
  // CHECK: [[INVOKECONT8]]:
  // CHECK-NEXT: %[[CALL:.+]] = invoke {{.*}}dereferenceable(16) %class.Bar* @_ZN3BaraSES_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b6:.+]], %class.Bar* {{(nonnull )?}}%[[AGGTMP3]])
  // CHECK-NEXT: to label %[[INVOKECONT9:.+]] unwind label %[[DETLPAD3_3:.+]]
  // CHECK: [[INVOKECONT9]]:
  // CHECK-NEXT: call void @_ZN3BarD1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP3]])
  // CHECK-NEXT: call void @_ZN4DBarD1Ev(%class.DBar* {{(nonnull )?}}dereferenceable(16) %[[REFTMP3]])
...
void two_classes() {
  ...
  // CHECK: invoke void @_Z7makeBazv(%class.Baz* {{(nonnull )?}}sret(%class.Baz) {{.*}}%[[REFTMP]])
  // CHECK-NEXT: to label %[[INVOKECONT:.+]] unwind label %[[DETLPAD:.+]]
  // CHECK: [[INVOKECONT]]:
  // CHECK-NEXT: invoke void @_ZN3BarC1ERK3Baz(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b12:.+]], %class.Baz* {{(nonnull )?}}{{.*}}dereferenceable(1) %[[REFTMP]])
  // CHECK-NEXT: to label %[[INVOKECONT2:.+]] unwind label %[[DETLPAD_2:.+]]
  // CHECK: [[INVOKECONT2]]:
  // CHECK-NEXT: call void @_ZN3BazD1Ev(%class.Baz* {{(nonnull )?}}dereferenceable(1) %[[REFTMP]])
  ...
  // CHECK: %[[AGGTMP:.+]] = alloca %class.Bar
  // CHECK: invoke void @_ZN3BarC1ERKS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[b9:.+]])
  // CHECK-NEXT: to label %[[INVOKECONT3:.+]] unwind label %[[TFLPAD2:.+]]
  // CHECK: [[INVOKECONT3]]:
  ...
  // CHECK: invoke void @_Z14makeBazFromBar3Bar(%class.Baz* {{(nonnull )?}}sret(%class.Baz) {{.*}}%[[REFTMP2]], %class.Bar* {{(nonnull )?}}%[[AGGTMP]])
  // CHECK-NEXT: to label %[[INVOKECONT4:.+]] unwind label %[[DETLPAD2:.+]]
  // CHECK: [[INVOKECONT4]]:
  // CHECK-NEXT: invoke void @_ZN3BarC1ERK3Baz(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b13:.+]], %class.Baz* {{(nonnull )?}}{{.*}}dereferenceable(1) %[[REFTMP2]])
  // CHECK-NEXT: to label %[[INVOKECONT5:.+]] unwind label %[[DETLPAD2_2:.+]]
  // CHECK: [[INVOKECONT5]]:
  // CHECK-NEXT: call void @_ZN3BazD1Ev(%class.Baz* {{(nonnull )?}}dereferenceable(1) %[[REFTMP2]])
  ...
  // CHECK: %[[AGGTMP2:.+]] = alloca %class.Bar
  // CHECK: invoke void @_ZN3BarC1ERKS_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP2]], %class.Bar* {{(nonnull )?}}{{.*}}dereferenceable(16) %[[b11:.+]])
  // CHECK-NEXT: to label %[[INVOKECONT6:.+]] unwind label %[[TFLPAD3:.+]]
  // CHECK: [[INVOKECONT6]]:
  ...
  // CHECK: invoke void @_Z14makeBazFromBar3Bar(%class.Baz* {{(nonnull )?}}sret(%class.Baz) {{.*}}%[[REFTMP3]], %class.Bar* {{(nonnull )?}}%[[AGGTMP2]])
  // CHECK-NEXT: to label %[[INVOKECONT7:.+]] unwind label %[[DETLPAD3:.+]]
  // CHECK: [[INVOKECONT7]]:
  // CHECK-NEXT: invoke void @_ZN3BarC1ERK3Baz(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP3]], %class.Baz* {{(nonnull )?}}{{.*}}dereferenceable(1) %[[REFTMP3]])
  // CHECK-NEXT: to label %[[INVOKECONT8:.+]] unwind label %[[DETLPAD3_2:.+]]
  // CHECK: [[INVOKECONT8]]:
  // CHECK-NEXT: %[[CALL:.+]] = invoke {{.*}}dereferenceable(16) %class.Bar* @_ZN3BaraSES_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[b9:.+]], %class.Bar* {{(nonnull )?}}%[[AGGTMP3]])
  // CHECK-NEXT: to label %[[INVOKECONT9:.+]] unwind label %[[DETLPAD3_3:.+]]
  // CHECK: [[INVOKECONT9]]:
  // CHECK-NEXT: call void @_ZN3BarD1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP3]])
  // CHECK-NEXT: call void @_ZN3BazD1Ev(%class.Baz* {{(nonnull )?}}dereferenceable(1) %[[REFTMP3]])
...
void array_out() {
  ...
  // CHECK: invoke void @_ZN3BarC1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP]])
  ...
  // CHECK-O1-NEXT: %[[REFTMPADDR:.+]] = getelementptr inbounds %class.Baz, %class.Baz* %[[REFTMP]], i64 0, i32 0
  // CHECK-O1-NEXT: call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %[[REFTMPADDR]])
  // CHECK: invoke void @_Z14makeBazFromBar3Bar(%class.Baz* {{(nonnull )?}}sret(%class.Baz) {{.*}}%[[REFTMP]], %class.Bar* {{(nonnull )?}}%[[AGGTMP]])
  // CHECK: to label %[[INVOKECONT2:.+]] unwind label %[[DETLPAD:.+]]
  // CHECK: [[INVOKECONT2]]:
  // CHECK-NEXT: invoke void @_ZN3BarC1ERK3Baz(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP2]], %class.Baz* {{(nonnull )?}}{{.*}}dereferenceable(1) %[[REFTMP]])
  // CHECK-NEXT: to label %[[INVOKECONT3:.+]] unwind label %[[DETLPAD_2:.+]]
  // CHECK: [[INVOKECONT3]]:
  // CHECK-NEXT: %[[CALL:.+]] = invoke {{.*}}dereferenceable(16) %class.Bar* @_ZN3BaraSES_(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[ARRIDX]], %class.Bar* {{(nonnull )?}}%[[AGGTMP2]])
  ...
  // CHECK: detach within %[[SYNCREG]], label %[[DETACHED2:.+]], label %[[CONTINUE2:.+]] unwind label %[[TFLPAD2:.+]]
  // CHECK: [[DETACHED2]]:
  // CHECK: invoke void @_ZN3BarC1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[ARRIDX2]])
  ...
  // CHECK: invoke void @_Z7makeBarv(%class.Bar* {{(nonnull )?}}sret(%class.Bar) {{.*}}%[[ARRIDX3]])
  ...
  // CHECK: %[[REFTMP2:.+]] = alloca %class.Baz
  // CHECK: %[[AGGTMP3:.+]] = alloca %class.Bar
  // CHECK: invoke void @_ZN3BarC1Ev(%class.Bar* {{(nonnull )?}}dereferenceable(16) %[[AGGTMP3]])
  ...
  // CHECK-O1-NEXT: %[[REFTMP2ADDR:.+]] = getelementptr inbounds %class.Baz, %class.Baz* %[[REFTMP2]], i64 0, i32 0
  // CHECK-O1-NEXT: call void @llvm.lifetime.start.p0i8(i64 1, i8* nonnull %[[REFTMP2ADDR]])
  // CHECK: invoke void @_Z14makeBazFromBar3Bar(%class.Baz* {{(nonnull )?}}sret(%class.Baz) {{.*}}%[[REFTMP2]], %class.Bar* {{(nonnull )?}}%[[AGGTMP3]])
